...
import com.damon.gateway.filter.JwtTokenAuthenticationFilter;
	...
	@Override
  	protected void configure(HttpSecurity http) throws Exception {
		...
		.authorizeRequests()
		   ...
		   .antMatchers(HttpMethod.POST, "/user/api/v1/add").permitAll()
...
//		   .antMatchers(HttpMethod.GET, "/account/api/v1/query").permitAll()
		   ...
		   .antMatchers("/user/**", "/course/**", "/mentor/**").hasAnyRole("admin","mentor")
